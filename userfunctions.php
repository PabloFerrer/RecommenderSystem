...
function user_similitude($userid){
	...
	$sql_query = "SELECT DISTINCT ratings1.movieid, ratings1.rating AS rating1, ratings2.rating AS rating2 FROM ratings AS ratings1, ratings AS ratings2 WHERE ratings1.userid = '$userid' AND ratings2.userid='3' AND ratings1.movieid = ratings2.movieid";
	$result = $con->query($sql_query);
	$movielist2 = array();
	$ratings1 = array();
	$ratings2 = array();
